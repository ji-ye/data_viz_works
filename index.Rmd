---
title: "Untitled (Static Visualization Work in Progress)"
author: "Ji, Ye"
date: "10/29/2017"
output:
  html_document:
...
```{r, eval=FALSE, dpi=200, fig.asp=.65}
# graph 2-1: nodes map (updated week 5)

# ISSUE (RESOLVED): How to color code by country's node count?
# ISSUE (RESOLVED): The map projection method is visibly elongated for tropical areas.

# I like this white NA value specification much more than previous version,
# because the absence of African countries is made obvious.
nodes_map <- ggplot(data = joined, aes(x = long, y = lat, group = group, fill = node_count)) +
  geom_polygon(color = "white") +
  coord_map("gall", 45, ylim = c(90, -60)) + 
  theme_clean_map() +
  scale_fill_continuous(low = "#E1E1E1", high = "#666666", na.value = "#ffffff")

nodes_map <- nodes_map +
  ggtitle("Global Nodes Distribution is uneven across continents",
          subtitle = "darker shade represents more nodes") +
...
```{r, eval=FALSE, dpi=200}
# (Removed week 5) graph 2-2: waffle chart
# This waffle chart is removed due to chaotic color scheme and the low customizability of Waffle Package.
# ISSUE: Is the Waffle package at all customizable?
