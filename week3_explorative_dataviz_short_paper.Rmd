...
clue to pinpoint certain time points wheen a new policy may have
an impact on the price of Bitcoin, or vice versa. Additionally, 
...
the countries arer involved in Bitcoin mining, which indicates
that these countries are more likely to have favorable policies,
or the lack of, to support the development of cryptocurrency.
Therefore, this graph can help narrow down the origin of some
major policies that have shaped the development of Bitcoin. This
graph can be regard as a ranking of countries' involvement in
digital currency. It is interesting to note that, this ranking is
not necessarily ordered in accordance with the ranking of GDP,
population, or even perceived internet presence by countries.
...
volatile, perhaps even more so than its price. This usually suggests market
manipulation, especially given Bitcoin's young economy, novel nature, and
lack of regulation. Together with the price trend, this can help identify
major policy change that either encourage (spike) or discourage (trough)
speculation.
...
player that can manipulate Bitcoin price. Second, although orange
(trustworthy) is more prevalent, there are quite a few blue spots 
on this heatmap, showing the users that are rated as fraud by other users.
At a glimpse, This graph shows that fraud is frequent in digital currency
market, which underscores its unregulated nature.
...
network graph serves as a piece of evidence to show that most people purcahse Bitcoin
for speculation, it also shows that while the technological philosophy of
Bitcoin is decentralized, its commercial activity is very much the opposite.
